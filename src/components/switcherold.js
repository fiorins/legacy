...
class Switcher extends Component {
    ...
    render() { //appena si clicca cambia lo stato da 'cliccato' (true) a 'non cliccato' (false)
        return <div className="font-sourcecode" onClick={() => this.setState({ clicked: !this.state.clicked })}>
            {
                this.state.clicked ? <Eng /> : <Ita />
            }
        </div>
    }
}
