...
function Footer() {
    return (
        <footer className="border-t-2 border-primario pt-8 mt-8 mx-auto justify-around flex items-center w-11/12 sm:w-9/12 md:w-7/12">
            <p>
                <span className="font-righteous dark:text-gray-300">© </span>
                <span className="font-sourcecode dark:text-gray-300">2021</span>
            </p>

            <h1 className="flex items-center space-x-2 text-xs md:text-base">
